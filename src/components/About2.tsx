    ...
    <>
      ...
      <div className="w-full overflow-hidden justify-center items-center
       h-screen flex md:flex-row flex-col">
        ...
        <div
          ref={container}
          className="md:w-1/2 w-full h-[15rem] mt-20 flex lg:-translate-x-[10%] md:-translate-x-[10%] -translate-x-[15%] flex-col justify-center items-center relative -translate-y-[10%] md:translate-y-[10%] "
        >
          <div
            ref={circle1}
